...
function AddUser() {
  ...
  return (
    <Modal btnIcon={<FiPlusCircle size={20} />} btnTitle="Add User" modalTitle="Add a new user">
        ...
        <div className="flex flex-col  items-center w-full">
          ...
          <div className="flex justify-center gap-2 mt-4 items-center">
            ...
            <div className="modal-action">
              ...
              <label type="button" htmlFor="modal-box-content" className="btn w-[80px] btn-sm btn-warning">Close</label>
            </div>
